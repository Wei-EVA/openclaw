...
/** Extract text and annotation-based citations from xAI Responses API output. */
function extractGrokContent(data: GrokSearchResponse): {
  text: string | undefined;
  annotationCitations: string[];
} {
  // xAI Responses API: find the message output with text content
...
async function runGrokSearch(params: {
  ...
  // them from the response without requesting them explicitly.
