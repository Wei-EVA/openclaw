...
const FIELD_LABELS: Record<string, string> = {
  ...
  "childSafety.enabled": "Enable Child Safety",
  "childSafety.mode": "Child Safety Mode",
  "childSafety.ageBand": "Child Safety Age Band",
  "childSafety.riskThresholds.blockAbove": "Child Safety Block Threshold",
  "childSafety.riskThresholds.rewriteAbove": "Child Safety Rewrite Threshold",
  "childSafety.riskThresholds.escalateAbove": "Child Safety Escalate Threshold",
  "childSafety.allowedDomains": "Child Safety Allowed Domains",
  "childSafety.blockedCategories": "Child Safety Blocked Categories",
  "childSafety.logPassEvents": "Child Safety Log Pass Events",
